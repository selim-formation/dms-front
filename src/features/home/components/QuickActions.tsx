export function QuickActions() {
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-8 sticky top-6">
      ...
      <div className="space-y-3">
        <button className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-100 bg-gray-50/50 hover:bg-blue-50/50 hover:border-blue-100 transition-all group">
          <div className="flex items-center gap-4">
            ...
            <span className="font-medium text-gray-700 group-hover:text-blue-700 text-left">Browse Documents</span>
          </div>
          <span className="text-gray-300 group-hover:text-blue-400">→</span>
        </button>
        
        <button className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-100 bg-gray-50/50 hover:bg-purple-50/50 hover:border-purple-100 transition-all group">
          <div className="flex items-center gap-4">
            ...
            <span className="font-medium text-gray-700 group-hover:text-purple-700 text-left">View Statistics</span>
          </div>
