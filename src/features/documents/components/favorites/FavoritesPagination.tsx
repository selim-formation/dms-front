...
function FavoritesPagination({ currentPage, lastPage, onPageChange, disabled }: FavoritesPaginationProps) {
            ...
            <PaginationContent>
                ...
                <PaginationItem>
                    <span className="px-4 text-sm text-muted-foreground">
                        {t('favoritesPage.pageOf', { current: currentPage, last: lastPage })}
                    </span>
                </PaginationItem>
                <PaginationItem>
                    <PaginationNext
...
export default memo(FavoritesPagination);
